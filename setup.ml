...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1a95b3e32714bc81a07aa002b50e7f90) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("pa_ounit.syntax\nthreads", None)
                        ];
                      bs_build_tools =
                   ...
                   {
                      lib_modules = ["Ascii_table"; "Console"; "Std"];
                      lib_pack = true;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\190\164I\030?\148n\016n0\191\155i~>S";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
