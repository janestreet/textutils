(* OASIS_START *)
(* DO NOT EDIT (digest: 6a18b9a94015c41496eacde5b2f4cfea) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("textutils", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("textutils", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Text output utilities";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "6\021X\202\216\164\171\207\168\b\185\223\200*\237f";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
